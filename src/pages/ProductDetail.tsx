...
const ProductDetail = () => {
  ...
  >(null);
  const [relatedProducts, setRelatedProducts] = useState<Category[]>([]);
...
console.log(selectedProduct)
  ...
  useEffect(() => {
    ...
    const fetchData = () => {
      ...
      const catalogEntry: Catalog | undefined = catalogs.find(
        (cat) => cat.name.toLowerCase() === categoryName.toLowerCase()
      );

      if (catalogEntry) {
        // Find the product within this catalog
        const categoryEntry: Category | undefined =
          catalogEntry.categories.find(
            (cat) => cat.name.toLowerCase() === productName.toLowerCase()
          );
        ...
        if (categoryEntry) {
          ...
          const related: Category = catalogEntry.categories
            ...
            >
              ...
              <div className="variant-grid">
                {selectedProduct.subItems &&
                  selectedProduct.subItems.map((variant, index) => (
          ...
          <div className="product-tabs">
            ...
            <div className="tab-content py-4 px-3" id="productTabsContent">
              ...
              >
                ...
                <p>{selectedProduct.description}</p>
                <p>
                  At Akdenar, we take pride in offering only the highest quality
                  products sourced directly from trusted producers. Our{" "}
                  {selectedProduct.name} is carefully selected to ensure premium
                  quality and authentic taste that our customers have come to
                  expect from our brand.
                </p>
                <p>
                  Each batch undergoes strict quality control measures to
                  guarantee consistency and excellence. Whether you're buying
                  for personal use or for your business, you can trust that our
                ...
                <table className="table specifications-table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        {selectedProduct.subItems
                          ? selectedProduct.subItems.length
                          : 1}{" "}
                        variants
                      </td>
                    </tr>
              ...
              >
                ...
                <div className="usage-storage-content">
                  <div className="usage-section">
                    ...
                    <p>
                      Our {selectedProduct.name} is versatile and can be used in
                      various culinary applications. For best results, follow
                      these guidelines:
                    </p>
                    <ul>
                      <li>
                      ...
                      <li>
                        Follow recommended measurements for consistent results
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="storage-section">
                    ...
                    <p>
                      To maintain freshness and quality, proper storage is
                      essential:
                    </p>
                    <ul>
                      <li>
                      ...
                      <li>
                        Keep away from strong odors as the product may absorb
                        them
                      </li>
                      <li>Avoid exposure to moisture and humidity</li>
                      <li>
                        Optimal storage temperature: Room temperature or
                        slightly cooler
                      </li>
                      <li>
                        Check for any special storage instructions on the
                        package
                      </li>
                    </ul>
                  </div>
          ...
          <div className="row g-4">
            {relatedProducts.map((relatedProduct, index) => (
              <div key={index} className="col-md-6 col-lg-3">
                ...
                >
                  <Link
                    to={`/category/${category}/${relatedProduct.name
                      .toLowerCase()
                      .replace(/\s/g, "-")}`}
                  ...
                  >
                    ...
                    <div className="product-info">
                      ...
                      <p className="product-excerpt">
                        {relatedProduct.description.substring(0, 70)}...
                      </p>
